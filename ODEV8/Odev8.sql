...
UPDATE employee
SET email = 'edaozge@gmail.com'
WHERE name = 'Lincoln Cheale';

UPDATE employee
SET name = 'Lincoln Cheale'
WHERE birthday = '1994-01-05';

UPDATE employee
SET birthday = '2024-08-22'
WHERE email = 'lcheale1a@google.de';

UPDATE employee
SET email = 'hbickell1d@archive.org'
WHERE id = 10;
...
DELETE FROM employee
WHERE email = 'hbickell1d@archive.org';

DELETE FROM employee
WHERE id = 100;

DELETE FROM employee
WHERE birthday = '2024-08-22';